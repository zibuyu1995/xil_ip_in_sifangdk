...
proc update_PARAM_VALUE.REVISION { PARAM_VALUE.REVISION } {
	# Procedure called to update REVISION when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.REVISION { PARAM_VALUE.REVISION } {
	# Procedure called to validate REVISION
	return true
}
...
proc update_MODELPARAM_VALUE.REVISION { MODELPARAM_VALUE.REVISION PARAM_VALUE.REVISION } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.REVISION}] ${MODELPARAM_VALUE.REVISION}
}
