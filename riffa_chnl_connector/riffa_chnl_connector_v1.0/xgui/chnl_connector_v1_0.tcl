...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "CHNL_NUM" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_PCI_DATA_WIDTH" -parent ${Page_0}


}

proc update_PARAM_VALUE.CHNL_NUM { PARAM_VALUE.CHNL_NUM } {
	# Procedure called to update CHNL_NUM when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.CHNL_NUM { PARAM_VALUE.CHNL_NUM } {
	# Procedure called to validate CHNL_NUM
	return true
}
...
proc update_MODELPARAM_VALUE.CHNL_NUM { MODELPARAM_VALUE.CHNL_NUM PARAM_VALUE.CHNL_NUM } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.CHNL_NUM}] ${MODELPARAM_VALUE.CHNL_NUM}
}
