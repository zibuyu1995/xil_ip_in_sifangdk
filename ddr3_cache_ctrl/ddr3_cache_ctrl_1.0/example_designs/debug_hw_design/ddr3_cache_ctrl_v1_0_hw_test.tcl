# Runtime Tcl commands to interact with - ddr3_cache_ctrl_v1_0

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/ddr3_cache_ctrl_v1_0_include.tcl
...
# Test: AXI4_M
set wdata_axi4_m [get_init_data 0]
create_hw_axi_txn w_axi4_m_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_axi4_m}
create_hw_axi_txn r_axi4_m_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_axi4_m_addr
run_hw_axi w_axi4_m_addr
run_hw_axi r_axi4_m_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_axi4_m_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - AXI4_M"
} else {
	puts "Data comparison test fail for - AXI4_M, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
